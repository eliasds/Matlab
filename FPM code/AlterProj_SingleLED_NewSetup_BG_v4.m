...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numlit = 1;
addpath(['C:\Users\Ziji\Desktop\FPM code\Source_coding']);
addpath('C:\Users\Ziji\Desktop\FPM code\export_fig');

filedir = ['C:\Users\LiHao\Desktop\MCF10A\FP data\MCF10A-4\'];
...
ns1 = 1:Np-Nedge:2160; ns1 = ns1(1:end-1);
ns2 = 1:Np-Nedge:2560; ns2 = ns2(1:end-1);
...
for m = 1:Nimg
    ...
    bk1 = mean2(double(I(250:350,840:940)));
    bk2 = mean2(double(I(1000:1100,2050:2150)));
...
Imedian = squeeze(median(median(Ithresh_reorder,1),2));
...
f1 = figure(66); imagesc(-angle(O),[-.5,.5]); axis image; colormap gray; axis off
export_fig(f1,[out_dir,'\ph-',num2str(Np),'.tif'],'-m2');

f1 = figure(67); imagesc(abs(O)); axis image; colormap gray; axis off
export_fig(f1,[out_dir,'\ampl-',num2str(Np),'.tif'],'-m2');

% end % prepare for the stitch
