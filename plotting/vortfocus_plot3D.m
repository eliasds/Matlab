...
lastframe = '100-m';
m=0;
xyzfile='./analysis/DH-th5E-03_dernum5_day73581272554';
load('background.mat');
dirname='';
filename='DH_';
...
%     L=L+5;
%     figure(fignum)
    plot3(xscale*beadxyz(L+M).time(:,1),zscale*(10E-3-zmax+beadxyz(L+M).time(:,3)),yscale*(ymax-beadxyz(L+M).time(:,2)),'b.');
