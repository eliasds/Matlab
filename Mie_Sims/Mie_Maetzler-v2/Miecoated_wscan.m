function result = Miecoated_wscan(m1,m2,y,nsteps)
...
% and size parameters x=k0*a, y=k0*b, versus
% volume fraction w of coating, with nsteps increments 
...
output_parameters='m1(real,imag), m2(real, imag), x, y, Qext, Qsca, Qabs, Qb, <costeta>'
