function param_detect02(nfiles,s_raiz,umbral_1,umbral_2,area_1,area_2,caja,elipse)

% Election of the parameters will be used in "detect.m"

% The criteria of the detection of the spots are: gray scale, area and 
% shape (close to circular shape). It calculates the centroids of spot using
% a weight average with the gray scale.

% nfiles: number of files in which the parameters will be used 
...
pausar=4;               % time (seconds) to pause aftre analyzate "refresco" images
refresco=200;           % number of images betwen pauses
