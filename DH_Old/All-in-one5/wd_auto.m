...
function [th] = wd_auto(Imin, zmap, thlevel, erodenum, xcrop1, xcrop2, ycrop1, ycrop2);
...
if nargin>4
    th(1:ycrop1,1:xcrop1)=0;
    th(ycrop2:end,xcrop2:end)=0;
end
...
%% Put cropped section back in
th(1:ycrop1,1:xcrop1) = whiskers(1:ycrop1,1:xcrop1);
th(ycrop2:end,xcrop2:end) = whiskers(ycrop2:end,xcrop2:end);
